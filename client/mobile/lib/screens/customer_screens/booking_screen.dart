              ...
              child: TableCalendar(
                ...
                calendarStyle: CalendarStyle(
                  ...
                  todayDecoration: reservedRanges.any((range) =>
                          isSameDay(DateTime.now(), range.start) ||
                          isSameDay(DateTime.now(), range.end) ||
                          (DateTime.now().isAfter(range.start) &&
                              DateTime.now().isBefore(range.end)))
                      ? BoxDecoration(
                ...
                calendarBuilders: CalendarBuilders(
                  ...
                  defaultBuilder: (context, date, events) {
                    ...
                    if (reservedRanges.any((range) =>
                        dateOnly.isAtSameMomentAs(DateTime(range.start.year,
                    ...
                    } else if (isSameDay(fromDate, date) ||
                        isSameDay(toDate, date)) {
                      return Center(
                        child: Container(
                          decoration: BoxDecoration(
                            color: Colors.red[300],
