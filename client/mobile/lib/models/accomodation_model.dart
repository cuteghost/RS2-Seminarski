  ...
  factory AccommodationGET.fromJson(Map<String, dynamic> json) {
    return AccommodationGET(
      ...
      accommodationDetails: AccommodationDetails(
        ...
        privateBathroom:
            json['accommodationDetails']['privateBathroom'] as bool,
      ...
      images: json['accommodationImages'] != null
          ? AccommodationImages.fromJson(
...
class AccommodationImages {
  ...
  factory AccommodationImages.fromJson(Map<String, dynamic> json) {
    return AccommodationImages(
      images: json.keys
          .where((key) =>
              key != 'id' && json[key] != null && json[key] as String != '')
  ...
  static File base64ToImage(String base64image, String key) {
    ...
    Directory tempDir =
        Directory.systemTemp.createTempSync('accommodationImages');
