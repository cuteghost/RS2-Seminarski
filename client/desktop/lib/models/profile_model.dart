...
///
/// Sva tri korisnička DTO-a (`CustomerGET`, `PartnerGET`, `AdministratorGET`)
/// nasljeđuju `UserGET`, pa nose isti skup polja pod istim imenima.
enum UserRole {
...
class Profile {
  ...
  factory Profile.fromJson(Map<String, dynamic> json, {UserRole? role}) {
    Uint8List? image;
    ...
    return Profile(
      ...
      role: role ?? UserRole.fromJson(json['role']),
      socialLink: json['userSocialLink']?.toString() ?? '',
      isActive: json['userIsActive'] == true,
    );
  }
