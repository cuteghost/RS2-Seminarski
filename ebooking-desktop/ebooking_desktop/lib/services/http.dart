...
const String baseApiUrl = "https://localhost:7140/api";
...
class CountryHttpService {
  ...
  static Future<void> deleteCountry(int countryId) async {
  ...
  static Future<void> editCountry(String newName, int countryId) async {
    try {
